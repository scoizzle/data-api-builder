...
namespace Azure.DataApiBuilder.Service.Tests.OracleTests
{
    ...
    public class OracleGQLSupportedTypesTests : GraphQLSupportedTypesTestBase
    {
        ...
        /// <summary>
        /// Gets all the columns from the type_table using GraphQL query
        /// and validates the returned result from graphQL against the expected results
        /// </summary>
        [TestMethod]
        public override async Task TestAllTypesOnTypeTable()
        {
            await base.TestAllTypesOnTypeTable();
        }
    }
}
