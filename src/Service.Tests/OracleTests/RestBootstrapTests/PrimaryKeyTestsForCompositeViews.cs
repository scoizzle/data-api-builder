...
namespace Azure.DataApiBuilder.Service.Tests.OracleTests.RestBootstrapTests
{
    /// <summary>
    ...
    public class PrimaryKeyTestsForCompositeViews : SqlTestBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        [TestMethod, TestCategory(TestCategory.ORACLE)]
        public async Task MsSqlPrimaryKeyOnComplexCompositeView()
        {
            ...
            await SetupDatabaseAsync(compositeViewDbQuery, TestCategory.ORACLE, isExceptionExpected: true);
        }
