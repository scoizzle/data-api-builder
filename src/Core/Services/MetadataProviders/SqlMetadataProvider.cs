...
namespace Azure.DataApiBuilder.Core.Services
{
        ...
        where CommandT : DbCommand, new()
    {
        ...
        public async Task InitializeAsync(CancellationToken cancellationToken)
        {
            ...
            // the table-discovery query (IQueryBuilder.BuildGetAutoentitiesQuery). MsSql overrides
            // generation in MsSqlMetadataProvider; Oracle uses the shared implementation.
        ...
        /// <see cref="QueryAutoentitiesFromDatabaseAsync"/>. MSSQL overrides the generation path in
        /// MsSqlMetadataProvider; Oracle uses this shared implementation.
        /// </summary>
        ...
        protected internal virtual async Task<JsonArray?> QueryAutoentitiesFromDatabaseAsync(string autoentityName, Autoentity autoentity)
        {
